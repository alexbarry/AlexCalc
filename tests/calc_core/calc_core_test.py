...
tests = [
		...
		( 'sqrt(1e-100)', math.sqrt(1e-100) ),

		( '3e-100 * (1.5e-50 + 1.5e-50)', 3e-100 * (1.5e-50 + 1.5e-50) ),
		( 'sqrt(3e-100 * (1.5e-50 + 1.5e-50))', math.sqrt(3e-100 * (1.5e-50 + 1.5e-50))),
		...
		( "180deg",        180.0,             'degree'),
		( "180deg0'",      180.0,             'degree'),
		( "180deg30'",     180.5,             'degree'),
		( "180deg + 0deg30'",  180.5,             'degree'),
		( "180deg30'20\"",                180.5 + 20/60/60,  'degree'),
		( "180deg + 0deg30'20\"",         180.5 + 20/60/60,  'degree'),
		( "180deg + 0deg30' + 0deg20\"",  180.5 + 20/60/60,  'degree'),
		( "180deg30' + 0deg20\"",         180.5 + 20/60/60,  'degree'),
		...
		( "0deg30''", 30/60/60, 'gradian'),
		( "0deg30''", 30/60/60, 'degree'),

		( "0deg30'' + 0deg30''", 30/60/60 + 30/60/60, 'gradian'),
		( "0deg30'' + 0deg30''", 30/60/60 + 30/60/60, 'degree'),

		( '0deg30"', 30/60/60, 'gradian'),
		( '0deg30"', 30/60/60, 'degree'),

		( "0deg30'15''", 30/60 + 15/60/60, 'gradian'),
		( "0deg30'15\"", 30/60 + 15/60/60, 'gradian'),
